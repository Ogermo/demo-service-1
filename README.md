#Это Fork лабораторной работы по "Проектирование ПО", это совместная лабораторная которая пишется группой из 8 человек целый 4 курс и являлась Курсовым проектом для 7 семестра
